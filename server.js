...
app.post("/chat", (req, res) => {
  ...
  let reply =
    "Sorry, I didn't understand your question. Please ask college related queries.";
  ...
  /* -------- COLLEGE INFO -------- */
    ...
    reply =
      "VRPT College is located in Tamil Nadu. 📍 https://maps.google.com/?q=VRPT+College";
  }
  else if (msg.includes("established")) {
    reply =
      "VRPT College was established to provide quality technical education.";
  }
  ...
  /* -------- ADMISSION -------- */
    ...
    reply =
      "Admissions are open from June to July. Applications can be done online or at the college office.";
  }
  else if (msg.includes("eligibility")) {
    reply =
      "Eligibility depends on the course. For UG courses, students must pass 12th standard.";
  }
  else if (msg.includes("entrance exam")) {
    reply =
      "No separate entrance exam is required. Admission is based on academic merit.";
  }
  else if (msg.includes("last date")) {
    reply =
      "The last date for admission will be announced by the college office.";
  }
  ...
  /* -------- COURSES -------- */
    ...
    reply =
      "Computer Engineering focuses on programming, software, and networking.";
  }
  else if (msg.includes("mechanical")) {
    reply =
      "Mechanical Engineering deals with machines, design, and manufacturing.";
  }
  else if (msg.includes("eee")) {
    reply =
      "EEE focuses on electrical systems, power, and electronics.";
  }
  else if (msg.includes("ece")) {
    reply =
      "ECE focuses on communication systems and electronic devices.";
  }
  else if (msg.includes("automobile")) {
    reply =
      "Automobile Engineering focuses on vehicle design, engines, and automotive systems.";
  }

  /* -------- FEES -------- */
  else if (msg.includes("fees") || msg.includes("tuition")) {
    reply =
      "Fees vary by course. Please contact the office for detailed fee structure.";
  }
  else if (msg.includes("installment")) {
    reply =
      "Yes, fee installment options are available.";
  }
  ...
  /* -------- SCHOLARSHIP -------- */
    ...
    reply =
      "Financial aid support is available for deserving students.";
  }
  ...
  /* -------- FACILITIES -------- */
    ...
    reply =
      "The college has a well-equipped library with digital resources.";
  }
  else if (msg.includes("lab")) {
    reply =
      "Modern laboratories and computer labs are available.";
  }
  else if (msg.includes("wifi")) {
    reply =
      "Yes, the campus provides WiFi and internet facilities.";
  }

  /* -------- STUDENT LIFE -------- */
  else if (msg.includes("sports")) {
    reply =
      "Sports facilities are available and students can participate in competitions.";
  }
  else if (msg.includes("clubs")) {
    reply =
      "Technical and cultural clubs are active in the college.";
  }
  else if (msg.includes("events")) {
    reply =
      "Cultural, technical, and academic events are conducted regularly.";
  }

  /* -------- PLACEMENT -------- */
  else if (msg.includes("placement")) {
    reply =
      "The college has a dedicated placement cell.";
  }
  else if (msg.includes("companies")) {
    reply =
      "Many reputed companies visit the campus for recruitment.";
  }
    ...
    reply =
      "Job-oriented training and placement assistance are provided.";
  }
